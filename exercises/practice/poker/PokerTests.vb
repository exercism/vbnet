Public Class PokerTests
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Both_hands_have_two_identically_ranked_pairs_tie_goes_to_remaining_card_kicker()
    ...
    Public Sub With_multiple_decks_two_players_can_have_same_three_of_a_kind_ties_go_to_highest_remaining_cards()
        Dim hands = {"5S AH AS 7C AD", "4S AH AS 8C AD"}
        Dim expected = {"4S AH AS 8C AD"}
        Assert.Equal(expected, Poker.BestHands(hands))
    End Sub
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Aces_can_end_a_straight_10_j_q_k_a()
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Aces_can_start_a_straight_a_2_3_4_5()
    ...
    Public Sub Both_hands_have_a_flush_tie_goes_to_high_card_down_to_the_last_one_if_necessary()
        Dim hands = {"2H 7H 8H 9H 6H", "3S 5S 6S 7S 8S"}
        Dim expected = {"2H 7H 8H 9H 6H"}
        Assert.Equal(expected, Poker.BestHands(hands))
    End Sub
