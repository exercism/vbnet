Public Class VariableLengthQuantityTests
    ...
    Public Sub Many_multi_byte_values()
        ...
        Dim expected = {
            &HC0UI, &H0UI, &HC8UI, &HE8UI, &H56UI, &HFFUI, &HFFUI, &HFFUI,
            &H7FUI, &H0UI, &HFFUI, &H7FUI, &H81UI, &H80UI, &H0UI
        }
    ...
    Public Sub Incomplete_sequence_causes_error()
        Dim integers = {&HFFUI}
        Assert.Throws(Of InvalidOperationException)(Function() VariableLengthQuantity.Decode(integers))
    End Sub
