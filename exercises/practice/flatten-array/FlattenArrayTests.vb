Public Class FlattenArrayTests
    ...
    Public Sub Empty()
        ...
        Dim expected = System.Array.Empty(Of Integer)()
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Five_level_nesting()
        Dim array = New Object() {
            0,
            2,
            New Object() {
                New Object() {2, 3},
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Six_level_nesting()
        Dim array = New Object() {
            1,
            New Object() {
                2,
                New Object() {New Object() {3}},
                New Object() {4, New Object() {New Object() {5}}},
                6,
                7
            },
            8
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Six_level_nested_array_with_null_values()
        Dim array = New Object() {
            0,
            2,
            New Object() {
    ...
    Public Sub All_values_in_nested_array_are_null()
        Dim array = New Object() {
            Nothing,
            New Object() {New Object() {New Object() {Nothing}}},
            Nothing,
            Nothing,
            New Object() {New Object() {Nothing, Nothing}, Nothing},
            Nothing
        }
        Dim expected = System.Array.Empty(Of Integer)()
        Assert.Equal(expected, FlattenArray.Flatten(array))
