Public Class TreeBuildingTests
    ...
    Public Sub Empty_list()
        Dim records = Array.Empty(Of TreeBuildingRecord)()

        Assert.Throws(Of ArgumentException)(Function() TreeBuilder.BuildTree(records))
    End Sub

    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Single_record()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0}
        }
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Three_records_in_order()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 0}
        }
        Dim tree = TreeBuilder.BuildTree(records)
    ...
    <Fact(Skip:="Remove this Skip property to run this test")>
    Public Sub Three_records_in_reverse_order()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0}
    ...
    Public Sub More_than_two_children()
        Dim records = {
            ...
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 3, .ParentId = 0}
        }
        Dim tree = TreeBuilder.BuildTree(records)
    ...
    Public Sub Binary_tree()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 5, .ParentId = 1},
            New TreeBuildingRecord With {.RecordId = 3, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 4, .ParentId = 1},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 6, .ParentId = 2}
        }
        Dim tree = TreeBuilder.BuildTree(records)
    ...
    Public Sub Unbalanced_tree()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 5, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 3, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 4, .ParentId = 1},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
    ...
    Public Sub One_root_node_and_has_parent()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 1}
        }
    ...
    Public Sub Non_continuous()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 4, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0}
        }
    ...
    Public Sub Cycle_directly()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 5, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 3, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 4, .ParentId = 1},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 6, .ParentId = 3}
        }
    ...
    Public Sub Cycle_indirectly()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 5, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 3, .ParentId = 2},
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 6},
            New TreeBuildingRecord With {.RecordId = 4, .ParentId = 1},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 6, .ParentId = 3}
    ...
    Public Sub Higher_id_parent_of_lower_id()
        Dim records = {
            New TreeBuildingRecord With {.RecordId = 0, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 2, .ParentId = 0},
            New TreeBuildingRecord With {.RecordId = 1, .ParentId = 2}
        }
