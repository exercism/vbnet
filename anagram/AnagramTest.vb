...
Public Class AnagramTest
    ...
    '<Ignore>
    <Test>
    Public Sub Detect_simple_anagram()
    ...
    '<Ignore>
    <Test>
    Public Sub Detect_multiple_anagrams()
    ...
    '<Ignore>
    <Test>
    Public Sub Does_not_confuse_different_duplicates()
    ...
    '<Ignore>
    <Test>
    Public Sub Identical_word_is_not_anagram()
    ...
    '<Ignore>
    <Test>
    Public Sub Eliminate_anagrams_with_same_checksum()
    ...
    '<Ignore>
    <Test>
    Public Sub Eliminate_anagram_subsets()
    ...
    '<Ignore>
    <Test>
    Public Sub Anagrams_are_case_insensitive()
